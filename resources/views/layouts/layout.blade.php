        ...
        <ul class="nav justify-content-center d-flex" id="nav_b">
            ...
            <li class="nav-item">
                @if($pagina == 'quem_somos')
                    <a class="nav-link" href="{{ route('quem_somos') }}" style="font-weight: bolder; border-bottom: 5px solid #fff;">QUEM SOMOS</a>
                @else
                    <a class="nav-link" href="{{ route('quem_somos') }}">QUEM SOMOS</a>
                @endif
            </li>
            <li class="nav-item">
                @if($pagina == 'cash_carteira')
                    <a class="nav-link" href="{{ route('cash_carteira') }}" style="font-weight: bolder; border-bottom: 5px solid #fff;">CASH CARTEIRA</a>
                @else
                    <a class="nav-link" href="{{ route('cash_carteira') }}">CASH CARTEIRA</a>
                @endif
            </li>
            <li class="nav-item">
                @if($pagina == 'seja_credenciado')
                    <a class="nav-link" href="{{ route('landing_seja_credenciado') }}" style="font-weight: bolder; border-bottom: 5px solid #fff;">LOJISTA</a>
                @else
            ...
            <li class="nav-item">
                @if($pagina == 'credito')
                    <a class="nav-link" href="{{ route('credito') }}" style="font-weight: bolder; border-bottom: 5px solid #fff;">CRÉDITO</a>
                @else
            ...
            <li class="nav-item">
                @if($pagina == 'contato')
                    <a class="nav-link" href="{{ route('contato') }}" style="font-weight: bolder; border-bottom: 5px solid #fff;">CONTATO</a>
                @else
