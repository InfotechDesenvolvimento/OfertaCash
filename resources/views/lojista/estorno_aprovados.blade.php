@extends('layouts.layout_lojista', ['pagina' => 'estornos_aprovados'])

<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<link rel="stylesheet" href="{{ asset('resources/css/lojista/credenciadas.css') }}">
<script type="text/javascript" src="{{ asset('resources/js/lojista/estornos_aprovados.js')}}"></script>

@section('conteudo')}
    <div class="filtro_div">
        <div class="title">
            <h3>Estornos Aprovados</h3>
            <hr>
        </div>
