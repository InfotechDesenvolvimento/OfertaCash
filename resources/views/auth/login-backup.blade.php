...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <ul class="nav justify-content-center d-flex">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('seja_credenciado') }}">LOJISTA</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('cash-carteira') }}">CASH CARTEIRA</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}" style="font-weight: bolder; border-bottom: 5px solid #fff;">LOGIN</a>
            </li>
        </ul>
