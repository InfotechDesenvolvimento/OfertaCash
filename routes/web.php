...
Route::get('/seja_credenciado_landing', 'App\Http\Controllers\CredenciamentoController@landing')
        ->name('landing_seja_credenciado');

Route::get('/seja_credenciado', 'App\Http\Controllers\CredenciamentoController@index')
        ->name('seja_credenciado');
